...
from asyncio_test.flags2_common import main, HTTPStatus, Result, save_flag

# default set low to avoid errors from remote site, such as
# 503 - Service Temporarily Unavailable
DEFAULT_CONCUR_REQ = 5 # 默认协程数
MAX_CONCUR_REQ = 1000 # 最大协程数
...
@asyncio.coroutine
def download_one(cc, base_url, semaphore, verbose):  # <3> semaphore = asyncio.Semaphore(concur_req)
    print(semaphore)
